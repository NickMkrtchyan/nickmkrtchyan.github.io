...
"use strict";function Pathformer(t){if(void 0===t)throw new Error('Pathformer [constructor]: "element" parameter is required');if(t.constructor===String&&!(t=document.getElementById(t)))throw new Error('Pathformer [constructor]: "element" parameter is not related to an existing ID');if(!(t.constructor instanceof window.SVGElement||/^svg$/i.test(t.nodeName)))throw new Error('Pathformer [constructor]: "element" parameter must be a string or a SVGelement');this.el=t,this.scan(t)}Pathformer.prototype.TYPES=["line","ellipse","circle","polygon","polyline","rect"],Pathformer.prototype.ATTR_WATCH=["cx","cy","points","r","rx","ry","x","x1","x2","y","y1","y2"],Pathformer.prototype.scan=function(t){for(var r,e,o,a=t.querySelectorAll(this.TYPES.join(",")),n=0;n<a.length;n++)e=(0,this[(r=a[n]).tagName.toLowerCase()+"ToPath"])(this.parseAttr(r.attributes)),o=this.pathMaker(r,e),r.parentNode.replaceChild(o,r)},Pathformer.prototype.lineToPath=function(t){var r={};return r.d="M"+t.x1+","+t.y1+"L"+t.x2+","+t.y2,r},Pathformer.prototype.rectToPath=function(t){var r={},e=parseFloat(t.x)||0,o=parseFloat(t.y)||0,a=parseFloat(t.width)||0,n=parseFloat(t.height)||0;return r.d="M"+e+" "+o+" ",r.d+="L"+(e+a)+" "+o+" ",r.d+="L"+(e+a)+" "+(o+n)+" ",r.d+="L"+e+" "+(o+n)+" Z",r},Pathformer.prototype.polylineToPath=function(t){var r,e,o={},a=t.points.trim().split(" ");if(-1===t.points.indexOf(",")){var n=[];for(r=0;r<a.length;r+=2)n.push(a[r]+","+a[r+1]);a=n}for(e="M"+a[0],r=1;r<a.length;r++)-1!==a[r].indexOf(",")&&(e+="L"+a[r]);return o.d=e,o},Pathformer.prototype.polygonToPath=function(t){var r=Pathformer.prototype.polylineToPath(t);return r.d+="Z",r},Pathformer.prototype.ellipseToPath=function(t){var r=t.cx-t.rx,e=t.cy,o=parseFloat(t.cx)+parseFloat(t.rx),a=t.cy,n={};return n.d="M"+r+","+e+"A"+t.rx+","+t.ry+" 0,1,1 "+o+","+a+"A"+t.rx+","+t.ry+" 0,1,1 "+r+","+a,n},Pathformer.prototype.circleToPath=function(t){var r={},e=t.cx-t.r,o=t.cy,a=parseFloat(t.cx)+parseFloat(t.r),n=t.cy;return r.d="M"+e+","+o+"A"+t.r+","+t.r+" 0,1,1 "+a+","+n+"A"+t.r+","+t.r+" 0,1,1 "+e+","+n,r},Pathformer.prototype.pathMaker=function(t,r){var e,o,a=document.createElementNS("http://www.w3.org/2000/svg","path");for(e=0;e<t.attributes.length;e++)o=t.attributes[e],-1===this.ATTR_WATCH.indexOf(o.name)&&a.setAttribute(o.name,o.value);for(e in r)a.setAttribute(e,r[e]);return a},Pathformer.prototype.parseAttr=function(t){for(var r,e={},o=0;o<t.length;o++){if(r=t[o],-1!==this.ATTR_WATCH.indexOf(r.name)&&-1!==r.value.indexOf("%"))throw new Error("Pathformer [parseAttr]: a SVG shape got values in percentage. This cannot be transformed into 'path' tags. Please use 'viewBox'.");e[r.name]=r.value}return e};
/**
...
!function(t){t.fn.animateIcon=function(n){if(1==this.length)var e=this[0].id;if("function"==typeof Pathformer&&"function"==typeof Vivus){window.iconObject={};var i=t.extend({type:"oneByOne",start:"inViewport",dashGap:20,duration:140},n);t("#"+e+" svg").each(function(){var n=function(){for(var t="",n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=0;e<10;e++)t+=n.charAt(Math.floor(Math.random()*n.length));return t}();t(this).attr("id",n),window.iconObject["tc"+n]=new Vivus(n,i)}),t("#"+e).each(function(){t("#"+t(this).attr("id")).delegate(".grid_item","mouseenter",function(){var n=t(this).find(".ai-icon svg").attr("id");if(!n)return!1;window.iconObject["tc"+n].reset().play()})})}else console.info("To use animateIcon make sure dependent plugins are available");return this}}(jQuery);
...
!function(){"use strict";var e,t={};function a(e){13===(e.which||e.keyCode)&&i(e)}function i(n){if(n.preventDefault(),!e){var o="-200vh";screen.orientation&&"landscape-primary"===screen.orientation.type&&(o="-270vh"),e=!0,anime({targets:t.intro,duration:1100,easing:"easeInOutSine",translateY:o}),anime({targets:t.shape,scaleY:[{value:[.8,1.8],duration:550,easing:"easeInQuad"},{value:1,duration:550,easing:"easeOutQuad"}]}),anime({targets:t.path,duration:1100,easing:"easeOutQuad",d:t.path.getAttribute("pathdata:id")}),t.enter.removeEventListener("click",i),t.enter.removeEventListener("touchenter",i),document.body.removeEventListener("keypress",a),setTimeout(function(){t.intro.remove(),t=null},2e3)}}function n(e){if(e){var t=getComputedStyle(e.parentElement),a=parseInt(t.height)-parseInt(t.paddingTop)-parseInt(t.paddingBottom),i=e.offsetHeight;e.style.transform="",screen.availWidth>767&&i>a&&(e.style.transform="scale("+a/i+")")}}function o(e,t){var a=new google.maps.LatLng(e,t),i=new google.maps.Map(document.querySelector(".gmap3-area"),{center:a,zoom:10,styles:[{featureType:"water",elementType:"geometry",stylers:[{color:"#e9e9e9"},{lightness:17}]},{featureType:"landscape",elementType:"geometry",stylers:[{color:"#f5f5f5"},{lightness:20}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#ffffff"},{lightness:17}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#ffffff"},{lightness:29},{weight:.2}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#ffffff"},{lightness:18}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#ffffff"},{lightness:16}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#f5f5f5"},{lightness:21}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#dedede"},{lightness:21}]},{elementType:"labels.text.stroke",stylers:[{visibility:"on"},{color:"#ffffff"},{lightness:16}]},{elementType:"labels.text.fill",stylers:[{saturation:36},{color:"#333333"},{lightness:40}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"transit",elementType:"geometry",stylers:[{color:"#f2f2f2"},{lightness:19}]},{featureType:"administrative",elementType:"geometry.fill",stylers:[{color:"#fefefe"},{lightness:20}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#fefefe"},{lightness:17},{weight:1.2}]}]});new google.maps.Marker({position:a,icon:"img/icon/map-marker.png",map:i})}document.body.classList.contains("home")&&(t.intro=document.querySelector(".content__intro"),t.shape=t.intro.querySelector("svg.shape"),t.path=t.shape.querySelector("path"),t.enter=document.querySelector(".enter"),t.shape.style.transformOrigin="50% 0%",t.path.setAttribute("pathdata:id",t.path.getAttribute("data-pathdata")),t.enter.addEventListener("click",i),t.enter.addEventListener("touchenter",i),document.body.addEventListener("keypress",a),$(".count").each(function(){$(this).prop("Counter",0).animate({counter:100},{duration:3e3,easing:"swing",step:function(e){$(this).text(Math.ceil(e))}}),$(this).fadeOut(2e3,function(){document.body.addEventListener("keypress",a)})}),$(".enter").delay(4500).fadeIn(1500),setTimeout(function(){document.querySelectorAll(".flex-content").forEach(n)},2e3)),document.body.classList.contains("home")&&function(){var e=0,t=document.getElementById("clio-cards"),a=document.getElementById("card-nav"),i=a.children,r=t.children,s=r.length,l=3,c=Math.ceil(s/l),d=0;function m(){window.innerWidth<768||(window.innerWidth<1201?(l=2,c=Math.ceil(s/l)):(l=3,c=Math.ceil(s/l)),d=0,n(document.querySelector(".profile-brief .flex-content")),f(),u())}function u(t){if(e)return!1;e=1,t&&(d=Number(t.target.getAttribute("data-page"))),function(){for(let e=0;e<i.length;e++)i[e].classList.remove("current");a.querySelector("[data-page='"+d+"']").classList.add("current")}();var m=d*l,u=(d+1)*l-s%l;for(let e=0;e<s;e++)r[e].setAttribute("card-active",0),r[e].style.opacity="",r[e].style.visibility="",r[e].classList.add("out"),r[e].classList.remove("in");for(let t=m;t<u;t++)!function(t){setTimeout(function(){var a;r[t].setAttribute("card-active",1),r[t].style.opacity=1,r[t].style.visibility="visible",r[t].classList.remove("out"),r[t].classList.add("in"),n(r[t].querySelector(".flex-content")),r[t].querySelector("svg")&&(a=r[t].querySelector("svg").id,window.iconObject["tc"+a].reset().play()),e=0,r[t].classList.contains("grid_item__map")&&setTimeout(()=>{o(document.getElementById("gmap").dataset.lat,document.getElementById("gmap").dataset.long),r[t].classList.add("grid_item__map-initialized"),r[t].classList.remove("grid_item__map")},300)},350)}(t);++d===c&&(d=0)}function f(){a.innerText="";for(let i=0;i<c;i++)a.appendChild((e=i,t=void 0,(t=document.createElement("li")).setAttribute("data-page",e),t.innerText="0"+(e+1),t.addEventListener("click",u),0===e&&t.classList.add("current"),t));var e,t}t.classList.remove("loading"),m(),window.addEventListener("resize",m),f(),u()}(),document.querySelector(".grid_item__map")&&window.innerWidth<768&&(o(document.getElementById("gmap").dataset.lat,document.getElementById("gmap").dataset.long),document.querySelector(".grid_item__map").classList.add("grid_item__map-initialized"),document.querySelector(".grid_item__map-initialized").classList.add("grid_item__map")),$(document).ready(function(){$(".offcanvus-video").lightGallery({selector:".openlightbox"}),$("#mixstart").lightGallery({selector:".gallery-item",subHtmlSelectorRelative:!0,thumbnail:!1}),$("img.svg").each(function(){var e=$(this),t=e.attr("id"),a=e.attr("class"),i=e.attr("src");$.get(i,function(i){var n=$(i).find("svg");void 0!==t&&(n=n.attr("id",t)),void 0!==a&&(n=n.attr("class",a)),n=n.removeAttr("xmlns:a"),e.replaceWith(n)},"xml")}),$(".testimonial-wrapper").owlCarousel({autoPlay:!0,slideSpeed:2e3,dots:!0,navigation:!1,items:1,smartSpeed:1200,margin:6}),$(".client-wrapper").owlCarousel({loop:!0,autoPlay:!0,slideSpeed:2e3,dots:!0,nav:!0,items:1,navText:["<i></i>","<i></i>"],smartSpeed:1200,margin:5}),$(".education_tab").champ(),$(".experience_tab").champ({multiple_tabs:"true"}),$(".portfolio").mCustomScrollbar({autoHideScrollbar:!0}),$(".sidebar-offcanvas").mCustomScrollbar({autoHideScrollbar:!0}),$("#mixstart").mixItUp(),$(".opener, .mobile-portfolio-opener").on("click",function(){$(".portfolio").toggleClass("active"),$(".container").toggleClass("open"),$(".mask-overlay").remove(),$(".sb_open").on("click",function(){$(".portfolio").removeClass("active"),$(".container").removeClass("open")})}),$(".sb_open").on("click",function(e){e.preventDefault();$(".sidebar-offcanvas").toggleClass("active"),$(".container").toggleClass("offcanvus-open"),$(".home").removeClass(".view-single"),$(".content").removeClass(".content--show"),$(".content__item").removeClass(".content__item--show"),$('<div class="mask-overlay"></div>').hide().appendTo("body").fadeIn("fast"),$(".mask-overlay,.sb_close,.opener").on("click",function(e){e.preventDefault(),$(".mask-overlay").remove(),$(".sidebar-offcanvas").removeClass("active"),$(".container").removeClass("offcanvus-open")})}),$("#accordian a").click(function(){var e=$(this),t=e.closest("ul"),a=t.find(".active"),i=e.closest("li"),n=i.hasClass("active"),o=0;t.find("ul").slideUp(function(){++o==t.find("ul").length&&a.removeClass("active")}),n||(i.children("ul").slideDown(),i.addClass("active"))}),$("#clio-cards").animateIcon({duration:100})})}();